						...
						<div class="blog_large">
							<article class="post">
								<figure class="post_img">
									<a href="#">
										<img src="<?php echo base_url().'assests/blog/'?>/blog_1.png" alt="blog post">
									</a>
								</figure>
								<div class="post_date">
							...
							<article class="post">
								<figure class="post_img">
									...
									<div id="slider" class="swipe">
										<ul class="swipe-wrap">
											<li><img src="<?php echo base_url().'assests/blog/'?>/blog_2.png" alt="blog post"></li>
											<li><img src="<?php echo base_url().'assests/blog/'?>/blog_1.png" alt="blog post"></li>
											<li><img src="<?php echo base_url().'assests/blog/'?>/blog_3.png" alt="blog post"></li>
										</ul>
							...
							<article class="post">
								<figure class="post_img">
									<a href="#">
										<img src="<?php echo base_url().'assests/blog/'?>/blog_2.png" alt="blog post">
									</a>
								</figure>
								<div class="post_date">
