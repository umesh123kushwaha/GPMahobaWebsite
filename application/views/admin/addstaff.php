        ...
        <div class="row ">
           <div class="col-lg-12 ">
            <div class="card card-primary">
                  ...
                  <form name="stafflForm" id="staffForm" method="post" enctype="multipart/form-data"action="<?php echo base_url().'admin/addstaff';?>" >
                 <div class="card-body">
                 
                 		
                 		<div class="form-group">
                 			<label>Staff Full Name :</label>
                 			<input type="text" name="sfname" placeholder="Enter Staff Name" class="form-control <?php echo (form_error('sfname')!='')?'is-invalid':'' ?>" value="<?php echo set_value('sfname') ?>" >
	                    ...
	                    <?php echo form_error('gender') ?>
                 		...
                 		<div class="form-group">
                 			...
                 			<textarea name="staff_about" id="description" class="textarea"><?php echo set_value('description');?></textarea>
                      ...
                      ?>
                 		...
                 		<div class="form-group">
                 			...
                 			<input type="date" name="jdate" value="<?php echo set_value('jdate');?>" id="jdate" class="form-control <?php echo (form_error('jdate') != "")?'is-invalid':'';?>" >
