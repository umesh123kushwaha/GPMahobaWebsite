assests<?php $this->load->view('staff/header')?>
        ...
        <div class="row ">
           <div class="col-lg-12 ">
            <div class="card card-primary">
                  ...
                  <form name="categoryForm" id="categoryForm" method="post" enctype="multipart/form-data"action="<?php echo base_url().'staff/category/edit/'.$category['id'];?>" >
                 <div class="card-body">
                 
                 		<div class="form-group">
                 			<label>Name</label>
                 			<input type="text" name="name" value="<?php echo set_value('name',$category['name']); ?>" id="name" class="form-control <?php echo (form_error('name') != "")?'is-invalid':'';?>">
                      ...
                      <?php echo (!empty($errorImageUpload)) ? $errorImageUpload :'';?>
                 		...
                 		<?php if (!empty($category['image'])) {
                 			# code...
                 		?>
                 		<img src="<?php echo base_url().'assests/uploads/category/thumb/'.$category['image']?>">
                 	<?php }else{?>
